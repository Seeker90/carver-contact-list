...
export const Contact = () => {
  ...
  const handleDelete = async (id) => {
    ...
    await deleteContact(id, dispatch);
    await fetchAllContacts(dispatch);
}
};
      ...
      <div className="container">
        {
          ...
          store.contacts.map(contact => {
            return (
              <div className="card d-inline-flex flex-row ms-3" key={contact.id}>
                <ContactCard
                  name={contact.name}
                  ...
                  email={contact.email}
                />
                <div className="ms-auto mt-5 gap-3 me-5">
                  <Link to={`/update_contact/${contact.id}`}>
                    <button
                      type="button"
